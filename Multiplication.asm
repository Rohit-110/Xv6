...
_Multiplication:     file format elf32-i386
...
int main(void)
{
   ...
   e:	83 ec 0c             	sub    $0xc,%esp
	printf(1," The product 16 times 4 is %d\n",multiplication(16,4));
  11:	6a 04                	push   $0x4
  13:	6a 10                	push   $0x10
  15:	e8 31 03 00 00       	call   34b <multiplication>
...
00000343 <subtraction>:
SYSCALL(subtraction)
 343:	b8 1a 00 00 00       	mov    $0x1a,%eax
 348:	cd 40                	int    $0x40
 34a:	c3                   	ret    

0000034b <multiplication>:
